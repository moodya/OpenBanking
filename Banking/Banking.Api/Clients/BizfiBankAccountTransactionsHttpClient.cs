...
{
    public class BizfiBankAccountTransactionsHttpClient : IAccountTransactionsHttpClient
    {
        private readonly IMapper _mapper;
        private readonly HttpClient _client;

        public BizfiBankAccountTransactionsHttpClient(IMapper mapper, string baseAddress)
        {
        ...
        public async Task<AccountTransactions> GetAsync(string accountNumber)
        {
            ...
            var transactions = JsonConvert.DeserializeObject<IEnumerable<BizfiBankTransaction>>(content);
