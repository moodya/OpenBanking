...
namespace Banking.Model.Extensions
{
    ...
    {
        public static PrimitivePropertyConfiguration HasUniqueKey(this PrimitivePropertyConfiguration configuration, string schemaName, string tableName, string columnName, int order = 1)
        {
